...
import { DeviceBreakdownCard } from "~/app/components/dashboard/device-breakdown-card";
import { ProductivityRing } from "~/app/components/dashboard/productivity-ring";
import { TopAppsCard } from "~/app/components/dashboard/top-apps-card";
import { WeeklySpark } from "~/app/components/dashboard/weekly-spark";
import { DateNavigator } from "~/app/components/ui/date-navigator";
import { Duration } from "~/app/components/ui/duration";
import { EmptyState } from "~/app/components/ui/empty-state";
import { useSummary } from "~/app/hooks/use-summary";
                ...
                <div className="space-y-4">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <p className="font-display text-4xl text-ink">
                                    <Duration
                                        secs={dailySummary.total_active_secs}
                                    />
                                </p>
                    ...
                    {dailySummary.top_apps.length > 0 && (
                        <Card>
                            ...
                            <CardContent>
                                <TopAppsCard apps={dailySummary.top_apps} />
                            </CardContent>
                        </Card>
                    )}
